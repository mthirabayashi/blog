...
RSpec.describe Api::PostsController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    it 'responds with JSON' do
      ...
      post = Post.create!(author_id: user.id, body: "test body")
      get :index, format: :json
  ...
  describe 'POST #create' do
    context 'with valid attributes' do
      it 'saves the new post in the database' do
        lb = Post.all.length
        post :create, params: {post: {author_id: user.id, body: 'test body'}}
  ...
  describe 'DELETE #destroy' do
    it 'deletes the user from the database' do
      Post.create!(author_id: user.id, body: "test body")
      post = Post.create!(author_id: user.id, body: "test body 2")
